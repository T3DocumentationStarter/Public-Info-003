...
Example::
   ...
   See `buildinfo <https://docs.typo3.org/typo3cms/drafts/github/T3DocumentationStarter/Public-Info-003/_buildinfo/>`__
...
Define the linktext `buildinfo` and the url somewhere in the document::
   ...
   .. _buildinfo: https://docs.typo3.org/typo3cms/drafts/github/T3DocumentationStarter/Public-Info-003/_buildinfo/
